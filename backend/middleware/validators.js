// middleware/validators.js - Updated for Password Reset
...
exports.validatePaymentMethod = [
  ...
  check('cardNumber', 'Valid card number is required')
    .if((body) => body.type === 'card')
    .isLength({ min: 13, max: 19 }),
  check('expiryDate', 'Valid expiry date is required in format MM/YY')
    .if((body) => body.type === 'card')
